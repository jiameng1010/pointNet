...
parser.add_argument('--log_dir', default='log/log_rbf7', help='Log dir [default: log]')
...
parser.add_argument('--decay_step', type=int, default=150000, help='Decay step for lr decay [default: 200000]')
